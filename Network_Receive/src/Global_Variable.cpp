 ...
 * @LastEditTime: 2022-01-05 19:51:52
 * @LastEditors: npuwth
 * @Copyright 2021
...
u_int8_t local_mac[6] = { 0x50, 0xE0, 0x85, 0xA7, 0x3D, 0x70 };
// u_int8_t local_ip[4] = { 10, 27, 36, 217 };
u_int8_t local_ip[4] = { 10, 27, 36, 216 };
...
pcap_t *handle;
u_int8_t target_mac[6] = { 0x50, 0xE0, 0x85, 0xA7, 0x3D, 0x7F };
u_int8_t target_ip[4] = { 10, 27, 36, 217 };
